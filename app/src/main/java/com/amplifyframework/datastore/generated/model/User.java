...
public final class User implements Model {
  ...
  public static final QueryField IMAGE_URL = field("User", "imageUrl");
  ...
  private final @ModelField(targetType="ChatRoomUser") @HasMany(associatedWith = "user", type = ChatRoomUser.class) List<ChatRoomUser> chatrooms = null;
  ...
  public List<ChatRoomUser> getChatrooms() {
      return chatrooms;
  }
  ...
  private User(String id, String name, String imageUrl, String status) {
    this.id = id;
    this.name = name;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), user.getId()) &&
              ...
              ObjectsCompat.equals(getImageUrl(), user.getImageUrl()) &&
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String imageUrl, String status) {
      super.id(id);
      super.name(name)
        .imageUrl(imageUrl)
        .status(status);
